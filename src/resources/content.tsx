...
const about: About = {
  ...
  intro: {
    ...
    description: (
  <>
    Sé lo que es la rabia de grabar un disco y que <span style={{ color: 'var(--brand-on-background-medium)' }}>suene a plástico</span>. En el Búnker, no hacemos grabaciones estándar; forjamos <span style={{ color: 'var(--brand-on-background-medium)' }}>sonido con autoridad</span>. Utilizamos herramientas de élite como el <span style={{ color: 'var(--brand-on-background-medium)' }}>Neumann U87</span> y previos <span style={{ color: 'var(--brand-on-background-medium)' }}>Clase A (Soundskulptor MP573)</span> para que tu potencia se traduzca en una pared de sonido sólida y real.
  </>
),
  },
  work: {
    ...
    experiences: [
      {
        ...
        achievements: [
          'Cadena de señal de alta gama: <span style="color: var(--brand-on-background-medium);">Pureza Clase A & A/B</span>.',
          'Captura de la <span style="color: var(--brand-on-background-medium);">actitud real</span>. Si no transmite, no sirve.',
        ],
        images: [],
      },
      {
